...
* parameters - общие параметры терминала.
    ...
    * auto_update - включить автоматическое обновление, значение по умолчанию - true. Если автоматическое обновление отключенно обновить ПО киоска можно tox-командой "service update".
		...
		- soft_update - значение по умолчанию "true" - флаг, отвечающий за "мягкое" обновление - ожидание программы простоя киоска без действий пользователя минимум "interval_for_activity" времени. Аналог для tox-команды - флаг "soft", пример: "service update -soft". 
